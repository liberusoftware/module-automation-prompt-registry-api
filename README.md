...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-automation-prompt-registry-api?sort=semver)](https://github.com/liberusoftware/module-automation-prompt-registry-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-automation-prompt-registry-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-automation-prompt-registry-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-automation-prompt-registry-api
```
...
<a href="https://github.com/liberusoftware/module-automation-prompt-registry-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-automation-prompt-registry-api" alt="Contributors to liberusoftware/module-automation-prompt-registry-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-automation-prompt-registry-api/graphs/contributors).
